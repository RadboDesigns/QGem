                            ...
                            <div class="nav-outer style1 clearfix">
                                ...
                                <nav class="main-menu style1 navbar-expand-md navbar-light">
                                    <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                        ...
                                        <li class="dropdown current"><a href="services.html"><span>Services</span></a>
                                        </li>
        ...
        <div class="row">
                ...
                <div class="about-style2__content">
                    <div class="sec-title sec-title--style2">
                        <div class="sub-title">
                            ...
                            <h3>We offer the entire range of services:</h3>
                        </div>
                        <h2>Auditing </h2>
                    </div>
                    <div class="inner-content">
            ...
            <div class="col-xl-6">
                <div class="about-style2__image clearfix">
                    ...
                    <div class="inner">
                        <img src="assets/images/about/auditing.jpg" alt="">
                    </div>
                </div>
            </div>
 ...
 <section class="about-style2-area">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-6">
                <div class="about-style2__image clearfix">
                    <div style="right: 550px;" class="shape-1"></div>
                    <div style="right: 700px;" class="shape-2"></div>
                    <div class="border-box float-bob-y"></div>
                    <div class="inner">
                        <img src="assets/images/about/consulting.jpg" alt="">
                    </div>
                </div>
            </div>
                ...
                <div class="about-style2__content">
                    ...
                    <div class="inner-content">
                        <div class="top-text">
                            ...
                            <div class="inner-title">
                                <h3>QGEM professional team has a wealth of experience in providing counselling on a long-term association, keeping a low profile, and based on the individual needs of the client. It is specially designed and delivered to meet the requirements and objectives of the client in any of the following approaches – Quality management systems, Environmental management systems, Safety, Security management system, Product certification. See more about our counselling processes in our company.</h3>
                            </div>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-6">
                <div class="about-style2__image clearfix">
                    ...
                    <div class="border-box float-bob-y"></div>
                    <div class="inner">
                        <img src="assets/images/about/implementation.jpg" alt="">
                    </div>
                </div>
            </div>
