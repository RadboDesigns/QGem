...
<body>
        ...
        <section class="google-map-area">
            <div class="auto-container">
                <div class="contact-page-map-outer">
                    <!--Map Canvas-->
                    <iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d248765.23334300064!2d79.83836965746936!3d13.0384236591551!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1s36%2F10%2CII%20Floor%2CCitybabu%20Street%2CManambedu%20Ambattur%2C%20Chennai-600053!5e0!3m2!1sen!2sin!4v1721387655879!5m2!1sen!2sin" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                    ...
                    <div class="contact-info-box">
                        ...
                        <div class="middle-box">
                            <p># 36/10,II Floor,Citybabu Street <br>Manambedu, Ambattur<br>Chennai-600053</p>
                        </div>
                        <div class="right-box">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            (function(){
                emailjs.init("JGFw6XaXcnJPQDRf6"); // Replace with your EmailJS user ID
            })();

            document.getElementById('tm-contact-form').addEventListener('submit', function(event) {
                event.preventDefault();

                // Send form data using EmailJS
                emailjs.sendForm('service_ao9wazx', 'template_c0vwwbb', this)
                    .then(function(response) {
                        alert('You Mail has been sent. Thank you!', 'SUCCESS!', response.status, response.text);
