                            ...
                            <div class="nav-outer style1 clearfix">
                                ...
                                <nav class="main-menu style1 navbar-expand-md navbar-light">
                                    <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                        ...
                                        <li class="dropdown current"><a href="training.html"><span>Training</span></a>
                                        </li>
...
<section class="service-details-area">
    <div class="container">
        <br class="row">
        <div class="col-xl-12">
            <div class="case-deatils-content">
                <div class="case-deatils__img-box">
                    <img src="assets/images/resources/case-deatils-img-1.jpg" alt="">
                </div>
            ...
            <div class="col-xl-12 order-box-1">
                        ...
                        <ul class="accordion-box">
                            <li class="accordion block active-block">
                                <div class="acc-btn active">
                                    ...
                                    <h3>Management System Awareness Training and Implementation Training:  </h3>
                                </div>
                                <div class="acc-content current">
                                    <ul>
                                        <li>
                                            <span class="icon-check"></span> QMS: ISO 9001:2015 (Quality Management Systems)
                                        </li>
                                        <li>
                                            <span class="icon-check"></span> EMS: ISO 14001:2015 (Environmental Management Systems)
                                        </li>
                                        <li>
                                            <span class="icon-check"></span> OHSMS: ISO 45001:2018 (Occupational Health and Safety Management System)
                                        </li>
                                        <li>
                                            <span class="icon-check"></span> FSMS: ISO 22000:2018 (Food Safety Management System)
                                        </li>
                                        <li>
                                            <span class="icon-check"></span> ISMS: ISO 27001:2022 (Information Security Management Systems)
                                        </li>
                                        <li>
                                            <span class="icon-check"></span> ITSMS: ISO 20000-1:2018 (Information Technology Service Management Systems)
                                        </li>
                                        <li>
                                            <span class="icon-check"></span> MDQMS: ISO 13485:2016 (Medical Device Quality Management Systems)
                                        </li>
                                        <li>
                            ...
                            <li class="accordion block">
                                <div class="acc-btn">
                                    ...
                                    <h3>Management System Internal Auditor Training and  Certification</h3>
                                </div>
