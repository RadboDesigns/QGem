                    ...
                    <div class="outer-box">
                                ...
                                <nav class="main-menu style1 navbar-expand-md navbar-light">
                                    <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                        <ul class="navigation clearfix">
                                            <li class="dropdown current"><a href="index.php"><span>Home</span></a>
                                            </li>
                        ...
                        <div class="header-right">
                            <div class="phone-number-box1">
                                ...
                                <div class="phone">
                                    <a href="tel:123456789">+91 95001 39192</a><br><a href="tel:123456789">+91 9965934720</a>
                                </div>
                            </div>
                        </div>
                        <!--End Header Right-->
                    ...
                    <div class="slide">
                        ...
                        <div class="auto-container">
                            <div class="content">
                                <div class="big-title">
                                    <h2 >
                                        An experienced<span class="dotted"></span><br>
                                        ISO Consulting <span class="dotted"></span><br>
                                        Firm<span class="dotted"></span>
                                    </h2>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="slide">
                        ...
                        <div class="auto-container">
                            <div class="content">
                                <div class="big-title">
                                    <h2>
                                        ISO, IATF<span class="dotted"></span><br>
                                        Awareness <span class="dotted"></span><br>
                                        Training<span class="dotted"></span>
                                    </h2>
                                </div>
                            </div>
                        </div>
        ...
        <section class="about-style1-area">
            <div class="container">
                <div class="sec-title text-center">
                    ...
                    <h2>We offer the entire range<br> of services</h2>
                </div>
                        ...
                        <div class="about-style1__content">
                            <div class="inner-content">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <span class="icon-check"></span>
                                        Twelve years in consulting experience with 150 Companies implemented in Management Systems.
                                    </li>
                                </ul>
                                            ...
                                            <div class="inner-box">
                                                <div class="graph-outer">
                                                    ...
                                                    <div class="inner-text count-box">
                                                        <span class="count-text" data-stop="100"
            ...
            <div class="btns-box" style="padding-left: 1000px;">
                    ...
                    <div class="col-xl-5">
                        <div class="service-style1__title">
                            <div class="sec-title sec-title--style2">
                                ...
                                <h2>We offer the entire range of <br> services:</h2>
                            </div>
                            <div class="inner-text">
                                <p>“A business succeeds not it is a big but it has been
                                    long established thorough your experience &build
                                    your great future plans for it”.
                                    </p>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6">
                                    <div class="single-service-style1">
                                        ...
                                        <div class="title-holder">
                                            <h3>
                                                <a href="services.php">Auditing </a>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6">
                                    <div class="single-service-style1">
                                        ...
                                        <div class="title-holder">
                                            <h3>
                                                <a href="services.php">Implementation </a>
                                            </h3>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="slogan-text-box">
                            <h2 class="paroller">We Provide <span
                                    ...
                                    Consulting & Management systems throughout<br> South India </h2>
        ...
        <section id="clients" class="partner-area">
            <div class="container"><br>
                <div class="sec-title text-center">
                    <div class="sub-title">
                        <div class="border-box"></div>
                        <h3>thank's for traveling with us</h3>
                    </div>
                    <h2>Our Clients</h2>
                </div>
                <div class="brand-content">
                    <div class="inner">
                        <ul class="partner-box partner-carousel owl-carousel owl-theme owl-dot-style1 rtl-carousel">
                            ...
                            <!--Start Single Partner Logo Box-->
                            <li>
                                <a href="#"><img src="assets/images/brand/brand-logo-9.png" alt="Awesome Image"></a>
                            </li>
                            <!--End Single Partner Logo Box-->
                            <!--Start Single Partner Logo Box-->
                            <li>
                                <a href="#"><img src="assets/images/brand/brand-logo-10.png" alt="Awesome Image"></a>
                            </li>
                            <!--End Single Partner Logo Box-->
                            <!--Start Single Partner Logo Box-->
                            <li>
                                <a href="#"><img src="assets/images/brand/brand-logo-11.png" alt="Awesome Image"></a>
                            </li>
                            <!--End Single Partner Logo Box-->
                            <!--Start Single Partner Logo Box-->
                            <li>
                                <a href="#"><img src="assets/images/brand/brand-logo-12.png" alt="Awesome Image"></a>
                                <li>
                                    <a href="#"><img src="assets/images/brand/brand-logo-13.png" alt="Awesome Image"></a>
                                </li>
                                <!--End Single Partner Logo Box-->
                                <!--Start Single Partner Logo Box-->
                                <li>
                                    <a href="#"><img src="assets/images/brand/brand-logo-14.png" alt="Awesome Image"></a>
                                </li>
                                <!--End Single Partner Logo Box-->
                                <!--Start Single Partner Logo Box-->
                                <li>
                                    <a href="#"><img src="assets/images/brand/brand-logo-15.png" alt="Awesome Image"></a>
                                </li>
                                <!--End Single Partner Logo Box-->
                                <!--Start Single Partner Logo Box-->
                                <li>
                                    <a href="#"><img src="assets/images/brand/brand-logo-16.png" alt="Awesome Image"></a>
                                </li>
                                <!--End Single Partner Logo Box-->
                                <!--Start Single Partner Logo Box-->
                                <li>
                                    <a href="#"><img src="assets/images/brand/brand-logo-17.png" alt="Awesome Image"></a>
                                    <li>
                                        <a href="#"><img src="assets/images/brand/brand-logo-18.png" alt="Awesome Image"></a>
                                    </li>
                                    <!--End Single Partner Logo Box-->
                                    <!--Start Single Partner Logo Box-->
                                    <li>
                                        <a href="#"><img src="assets/images/brand/brand-logo-19.png" alt="Awesome Image"></a>
                                    </li>
                                    <!--End Single Partner Logo Box-->
                                    <!--Start Single Partner Logo Box-->
                                    <li>
                                        <a href="#"><img src="assets/images/brand/brand-logo-20.png" alt="Awesome Image"></a>
                                    </li>
                                    <!--End Single Partner Logo Box-->
                                    <!--Start Single Partner Logo Box-->
                                    <li>
                                        <a href="#"><img src="assets/images/brand/brand-logo-21.png" alt="Awesome Image"></a>
                                    </li>
                                    <!--End Single Partner Logo Box-->
                                    <!--Start Single Partner Logo Box-->
                                    <li>
                                        <a href="#"><img src="assets/images/brand/brand-logo-22.png" alt="Awesome Image"></a>
                                        <li>
                                            <a href="#"><img src="assets/images/brand/brand-logo-23.png" alt="Awesome Image"></a>
                                        </li>
                                        <!--End Single Partner Logo Box-->
                                        <!--Start Single Partner Logo Box-->
                                        <li>
                                            <a href="#"><img src="assets/images/brand/brand-logo-24.png" alt="Awesome Image"></a>
                                        </li>
                                        <!--End Single Partner Logo Box-->
                                        <!--Start Single Partner Logo Box-->
                                        <li>
                                            <a href="#"><img src="assets/images/brand/brand-logo-25.png" alt="Awesome Image"></a>
                                        </li>
                                        <!--End Single Partner Logo Box-->
                                        <!--Start Single Partner Logo Box-->
                                        <li>
                                            <a href="#"><img src="assets/images/brand/brand-logo-26.png" alt="Awesome Image"></a>
                                        </li>
                                        <!--End Single Partner Logo Box-->
                                        <!--Start Single Partner Logo Box-->
                                        <li>
                                            <a href="#"><img src="assets/images/brand/brand-logo-27.png" alt="Awesome Image"></a>
                                            <li>
                                                <a href="#"><img src="assets/images/brand/brand-logo-28.png" alt="Awesome Image"></a>
                                            </li>
                                            <!--End Single Partner Logo Box-->
                                            <!--Start Single Partner Logo Box-->
                                            <li>
                                                <a href="#"><img src="assets/images/brand/brand-logo-29.png" alt="Awesome Image"></a>
                                            </li>
                                            <!--End Single Partner Logo Box-->
                                            <!--Start Single Partner Logo Box-->
                                            <li>
                                                <a href="#"><img src="assets/images/brand/brand-logo-30.png" alt="Awesome Image"></a>
                                            </li>
                                            <!--End Single Partner Logo Box-->
                                            <!--Start Single Partner Logo Box-->
                                            <li>
                                                <a href="#"><img src="assets/images/brand/brand-logo-31.png" alt="Awesome Image"></a>
                                            </li>
                                            <!--End Single Partner Logo Box-->
                                            <!--Start Single Partner Logo Box-->
                                            <li>
                                                <a href="#"><img src="assets/images/brand/brand-logo-32.png" alt="Awesome Image"></a>
                                            </li>
                                            <!--End Single Partner Logo Box-->
                                            <!--Start Single Partner Logo Box-->
                                            <li>
                                                <a href="#"><img src="assets/images/brand/brand-logo-33.png" alt="Awesome Image"></a>
                                            </li>
                                            <!--End Single Partner Logo Box-->
                                            <!--Start Single Partner Logo Box-->
                                            <li>
                                                <a href="#"><img src="assets/images/brand/brand-logo-34.png" alt="Awesome Image"></a>
                                            </li>
                                            <!--End Single Partner Logo Box-->
                        </ul>
                    </div>
                    ...
                    <div class="col-xl-12">
                        <div class="slogan-style2-content">
                            ...
                            <div class="button-box">
                                <a class="btn-one" href="services.php"><span class="txt">Discover More</span></a>
                            </div>
                        </div>
                    </div>
                </div>
